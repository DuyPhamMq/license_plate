...
def check_format_plate_append(lp):
    ...
    return: True or False
    """
    plate_format1 = compile("^[0-9]{2}[ABCDEFGHIJKLMNOPQRSTUVWXYZĐ]{1,2}([0-9]{4,5}|[0-9]{6})$")
    plate_format2 = compile("^[0-9]{4,5}[A-Z]{2}[0-9]{2,3}$")
    plate_format3 = compile("^[A-Z]{0,1}[0-9]{6,7}")
